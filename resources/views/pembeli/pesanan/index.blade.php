...
<div class="container">
	<form action="{{ route('order.store') }}" method="POST">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9">
				<div class="input-group mb-3">
					...
					<input type="text" name="title" class="form-control" placeholder="ex: ikan tuna segar 10 kg" aria-describedby="title" autocomplete="off" autofocus>
				</div>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9">
				<textarea class="form-control" name="description" placeholder="Deskripsi permintaan disini" id="description" rows="3"></textarea>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-2">
				<div class="input-group mb-3">
					<input type="number" name="weight" min="1" class="form-control"aria-describedby="weight" autocomplete="off">
